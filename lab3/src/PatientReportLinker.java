...
public class PatientReportLinker {
     ...
     */
    private static UpdateItemOutcome updateItemWithLink(DynamoDB dynamoDB, String tableName, String patientId, String reportUrl) {
        ...
        UpdateItemSpec updateItemSpec = new UpdateItemSpec()
                ...
                .withValueMap(new ValueMap().with(":val1", reportUrl))

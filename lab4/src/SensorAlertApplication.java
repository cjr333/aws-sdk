...
public final class SensorAlertApplication {
    ...
    private static KinesisClientLibConfiguration createKinesisConfig(String workerId) {
        ...
        return new KinesisClientLibConfiguration(APPLICATION_NAME, STREAM_NAME, credentialsProvider, workerId)
    ...
    private static Worker createWorker(KinesisClientLibConfiguration config) {
        ...
        return new Worker.Builder().recordProcessorFactory(new SensorRecordProcessorFactory()).config(config).build();
